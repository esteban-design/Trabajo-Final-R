...
--- A -- [Pagina_Web_ReGex_1](https://aprende-web.net/jspracticas/resumen/resumen9.php)


___Resumen De Pagina:___
...
--- B -- [Pagina_Web_ReGex_2](https://www.adictosaltrabajo.com/2015/01/29/regexsam/)
...
Las dos paginas contienes informacion clave sobre Expresiones Regulares pero la gran difrencia es que en 
[ReGex1] contiene espacios publicitarios y el diseño es un poco más confuso. En [ReGex2] el diseño es más 
simple pero para obtener mas información tienes que dar click en links que te llevaran a otra pagina y eso
...
--- A -- [Pagina_Web_MKD_1](http://www.unavarra.es/personal/tgoicoa/ESTADISTICA_RMarkdown_tomas/basicRmarkdown/index.html)
...
1. Guia sencilla para empezar con RMarkdown
...
--- B -- [Pagina_Web_MKD_2](http://www.rpubs.com/JohanMarin/Rmarkdown)
...
Podemos ver claramente que MKD1 es mucho mas simple y basica donde la informacion es clara y contiene ejemplos.
Se puede destacar que agregaron un indice donde puedes bucar la informacion que necesitas.
Por otro lado MKD2 es una pagina mucho mas completa donde aparte de explicaciones agregan imagenes que explican paso por paso que tienes que hacer.
...
Es el tronco se expresa con otro vector numérico en relacion a la circunferencia del tronco.
La medida está expresada en milimetros.
